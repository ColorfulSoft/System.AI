...
namespace System
{
    ...
    namespace AI
    {
        ...
        internal static partial class MKL
        {
            ...
            public static void Atan(Half[] x, Half[] y)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static void Atan(float[] x, float[] y)
            {
                var Threads = Environment.ProcessorCount;
                var TaskPart = x.Length / Threads;
                var TaskRemainder = x.Length % Threads;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static void Atan(double[] x, double[] y)
            {
                var Threads = Environment.ProcessorCount;
                var TaskPart = x.Length / Threads;
                var TaskRemainder = x.Length % Threads;
