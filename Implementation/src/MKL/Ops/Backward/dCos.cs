...
namespace System
{
    ...
    namespace AI
    {
        ...
        internal static partial class MKL
        {
            ...
            public static void dCos(Half[] x, Half[] dx, Half[] dy)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static void dCos(float[] x, float[] dx, float[] dy)
            {
                var Threads = Environment.ProcessorCount;
                var TaskPart = x.Length / Threads;
                var TaskRemainder = x.Length % Threads;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static void dCos(double[] x, double[] dx, double[] dy)
            {
                var Threads = Environment.ProcessorCount;
                var TaskPart = x.Length / Threads;
                var TaskRemainder = x.Length % Threads;
