...
public static partial class torch
{
    ...
    ///<param name = "dtype">The desired data type of returned tensor. Default: if not passed, infers data type from data.</param>
    ///<param name = "requires_grad">If autograd should record operations on the returned tensor. Default: false.</param>
    public static Tensor tensor(sbyte[] data, dtype dtype = torch.dtype.int8, bool requires_grad = false)
    {
        return new Tensor(data, dtype, requires_grad);
    }
    ...
    ///<param name = "dtype">The desired data type of returned tensor. Default: if not passed, infers data type from data.</param>
    ///<param name = "requires_grad">If autograd should record operations on the returned tensor. Default: false.</param>
    public static Tensor tensor(int[] data, dtype dtype = torch.dtype.int32, bool requires_grad = false)
    {
        return new Tensor(data, dtype, requires_grad);
    }
    ...
    public static Tensor tensor(Half data, dtype dtype = torch.dtype.float16, bool requires_grad = false)
    {
        var result = new Tensor(new Half[]{data}, dtype, requires_grad);
        result.__ndim = 0;
        return result;
    }
    ...
    public static Tensor tensor(sbyte data, dtype dtype = torch.dtype.int8, bool requires_grad = false)
    {
        var result = new Tensor(new sbyte[]{data}, dtype, requires_grad);
        result.__ndim = 0;
        return result;
    }
    ...
    public static Tensor tensor(short data, dtype dtype = torch.dtype.int16, bool requires_grad = false)
    {
        var result = new Tensor(new short[]{data}, dtype, requires_grad);
        result.__ndim = 0;
        return result;
    }
    ...
    public static Tensor tensor(int data, dtype dtype = torch.dtype.int32, bool requires_grad = false)
    {
        var result = new Tensor(new int[]{data}, dtype, requires_grad);
        result.__ndim = 0;
        return result;
    }
