...
public static partial class torch
{
    ...
    ///<param name = "dtype">the desired data type of returned tensor. Default: if None, uses a global default(see torch.set_default_tensor_type()).</param>
    ///<param name = "requires_grad">If autograd should record operations on the returned tensor. Default: False.</param>
    public static Tensor zeros(byte w, byte h, dtype dtype = dtype.@default, bool requires_grad = false)
    {
        return new Tensor(new Size(w, h), dtype, requires_grad);
    }
    ...
    ///<param name = "dtype">the desired data type of returned tensor. Default: if None, uses a global default(see torch.set_default_tensor_type()).</param>
    ///<param name = "requires_grad">If autograd should record operations on the returned tensor. Default: False.</param>
    public static Tensor zeros(byte w, byte h, byte d, dtype dtype = dtype.@default, bool requires_grad = false)
    {
        return new Tensor(new Size(w, h, d), dtype, requires_grad);
    }
    ...
    ///<param name = "dtype">the desired data type of returned tensor. Default: if None, uses a global default(see torch.set_default_tensor_type()).</param>
    ///<param name = "requires_grad">If autograd should record operations on the returned tensor. Default: False.</param>
    public static Tensor zeros(byte w, byte h, byte d, byte t, dtype dtype = dtype.@default, bool requires_grad = false)
    {
        return new Tensor(new Size(w, h, d, t), dtype, requires_grad);
    }
    ...
    ///<param name = "dtype">the desired data type of returned tensor. Default: if None, uses a global default(see torch.set_default_tensor_type()).</param>
    ///<param name = "requires_grad">If autograd should record operations on the returned tensor. Default: False.</param>
    public static Tensor zeros(int w, dtype dtype = dtype.@default, bool requires_grad = false)
    {
        return new Tensor(new Size(w), dtype, requires_grad);
    }
    ...
    ///<param name = "dtype">the desired data type of returned tensor. Default: if None, uses a global default(see torch.set_default_tensor_type()).</param>
    ///<param name = "requires_grad">If autograd should record operations on the returned tensor. Default: False.</param>
    public static Tensor zeros(int w, int h, dtype dtype = dtype.@default, bool requires_grad = false)
    {
        return new Tensor(new Size(w, h), dtype, requires_grad);
    }
    ...
    ///<param name = "dtype">the desired data type of returned tensor. Default: if None, uses a global default(see torch.set_default_tensor_type()).</param>
    ///<param name = "requires_grad">If autograd should record operations on the returned tensor. Default: False.</param>
    public static Tensor zeros(int w, int h, int d, dtype dtype = dtype.@default, bool requires_grad = false)
    {
        return new Tensor(new Size(w, h, d), dtype, requires_grad);
    }
    ...
    ///<param name = "dtype">the desired data type of returned tensor. Default: if None, uses a global default(see torch.set_default_tensor_type()).</param>
    ///<param name = "requires_grad">If autograd should record operations on the returned tensor. Default: False.</param>
    public static Tensor zeros(int w, int h, int d, int t, dtype dtype = dtype.@default, bool requires_grad = false)
    {
        return new Tensor(new Size(w, h, d, t), dtype, requires_grad);
    }
    ...
    ///<param name = "dtype">the desired data type of returned tensor. Default: if None, uses a global default(see torch.set_default_tensor_type()).</param>
    ///<param name = "requires_grad">If autograd should record operations on the returned tensor. Default: False.</param>
    public static Tensor zeros(long w, long h, dtype dtype = dtype.@default, bool requires_grad = false)
    {
        return new Tensor(new Size((int)w, (int)h), dtype, requires_grad);
    }
    ...
    ///<param name = "dtype">the desired data type of returned tensor. Default: if None, uses a global default(see torch.set_default_tensor_type()).</param>
    ///<param name = "requires_grad">If autograd should record operations on the returned tensor. Default: False.</param>
    public static Tensor zeros(long w, long h, long d, dtype dtype = dtype.@default, bool requires_grad = false)
    {
        return new Tensor(new Size((int)w, (int)h, (int)d), dtype, requires_grad);
    }
    ...
    ///<param name = "dtype">the desired data type of returned tensor. Default: if None, uses a global default(see torch.set_default_tensor_type()).</param>
    ///<param name = "requires_grad">If autograd should record operations on the returned tensor. Default: False.</param>
    public static Tensor zeros(long w, long h, long d, long t, dtype dtype = dtype.@default, bool requires_grad = false)
    {
        return new Tensor(new Size((int)w, (int)h, (int)d, (int)t), dtype, requires_grad);
    }
    ...
    ///<param name = "dtype">the desired data type of returned tensor. Default: if None, uses a global default(see torch.set_default_tensor_type()).</param>
    ///<param name = "requires_grad">If autograd should record operations on the returned tensor. Default: False.</param>
    public static Tensor zeros(byte[] size, dtype dtype = dtype.@default, bool requires_grad = false)
    {
    ...
    ///<param name = "dtype">the desired data type of returned tensor. Default: if None, uses a global default(see torch.set_default_tensor_type()).</param>
    ///<param name = "requires_grad">If autograd should record operations on the returned tensor. Default: False.</param>
    public static Tensor zeros(Tuple<byte> size, dtype dtype = dtype.@default, bool requires_grad = false)
    {
    ...
    ///<param name = "dtype">the desired data type of returned tensor. Default: if None, uses a global default(see torch.set_default_tensor_type()).</param>
    ///<param name = "requires_grad">If autograd should record operations on the returned tensor. Default: False.</param>
    public static Tensor zeros(Tuple<byte, byte, byte> size, dtype dtype = dtype.@default, bool requires_grad = false)
    {
    ...
    ///<param name = "dtype">the desired data type of returned tensor. Default: if None, uses a global default(see torch.set_default_tensor_type()).</param>
    ///<param name = "requires_grad">If autograd should record operations on the returned tensor. Default: False.</param>
    public static Tensor zeros(Tuple<byte, byte, byte, byte> size, dtype dtype = dtype.@default, bool requires_grad = false)
    {
    ...
    ///<param name = "dtype">the desired data type of returned tensor. Default: if None, uses a global default(see torch.set_default_tensor_type()).</param>
    ///<param name = "requires_grad">If autograd should record operations on the returned tensor. Default: False.</param>
    public static Tensor zeros(Tuple<byte, byte, byte, byte, byte> size, dtype dtype = dtype.@default, bool requires_grad = false)
    {
    ...
    {
        return new Tensor(new Size((int)size.Item1), dtype, requires_grad);
    }
    ...
    {
        return new Tensor(new Size((int)size.Item1, (int)size.Item2), dtype, requires_grad);
    }
    ...
    {
        return new Tensor(new Size((int)size.Item1, (int)size.Item2, (int)size.Item3), dtype, requires_grad);
    }
    ...
    {
        return new Tensor(new Size((int)size.Item1, (int)size.Item2, (int)size.Item3, (int)size.Item4), dtype, requires_grad);
    }
