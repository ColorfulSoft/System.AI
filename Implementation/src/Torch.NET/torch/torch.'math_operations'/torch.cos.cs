...
public static partial class torch
{
    ...
    public static Tensor cos(Tensor x)
    {
        ...
        switch(Result.dtype)
        {
            ...
            {
                throw new torch.TorchException("TorchException: torch.cos is not implemented for bool and integer tensors.");
            }
        }
        if(x.requires_grad)
        {
