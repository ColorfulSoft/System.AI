...
public static partial class torch
{
    ...
    public static Tensor atan(Tensor x)
    {
        ...
        switch(Result.dtype)
        {
            ...
            {
                throw new torch.TorchException("TorchException: torch.atan is not implemented for bool and integer tensors.");
            }
        }
        if(x.requires_grad)
        {
