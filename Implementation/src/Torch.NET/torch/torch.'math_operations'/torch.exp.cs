...
public static partial class torch
{
    ...
    public static Tensor exp(Tensor x)
    {
        ...
        switch(Result.dtype)
        {
            ...
            {
                throw new torch.TorchException("TorchException: torch.exp is not implemented for bool and integer tensors.");
            }
        }
        if(x.requires_grad)
        {
