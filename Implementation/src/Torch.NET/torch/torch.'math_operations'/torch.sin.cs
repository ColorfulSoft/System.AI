...
public static partial class torch
{
    ...
    public static Tensor sin(Tensor x)
    {
        ...
        switch(Result.dtype)
        {
            ...
            {
                throw new torch.TorchException("TorchException: torch.sin is not implemented for bool and integer tensors.");
            }
        }
        if(x.requires_grad)
        {
