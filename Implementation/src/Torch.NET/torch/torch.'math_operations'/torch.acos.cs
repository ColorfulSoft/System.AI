...
public static partial class torch
{
    ...
    public static Tensor acos(Tensor x)
    {
        ...
        switch(Result.dtype)
        {
            ...
            {
                throw new torch.TorchException("TorchException: torch.acos is not implemented for bool and integer tensors.");
            }
        }
        if(x.requires_grad)
        {
