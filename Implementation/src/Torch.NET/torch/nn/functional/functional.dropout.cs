...
//-> Latest commit: Brykin Gleb, 14.11.2019.
        ...
        public static partial class functional
        {
            ...
            public static Tensor dropout(Tensor x, float p = 0.5f, bool training = false)
            {
                ...
                switch(Result.dtype)
                {
                    ...
                    {
                        throw new torch.TorchException("TorchException: nn.functional.dropout is not implemented for bool and int tensors.");
                    }
                }
                if(x.requires_grad)
                {
