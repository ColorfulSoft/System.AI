                            ...
                            for(int out_depth = 0; out_depth < outD; out_depth++)
                            {
                                for(int out_width = 0; out_width < outW; out_width++)
                                {
                                    for(int out_height = 0; out_height < outH; out_height++)
                                    {
                                        ...
                                        Result.__data_float16[(((out_height * outW) + out_width) * outD + out_depth) * outB + batch] = max;
                            ...
                            for(int out_depth = 0; out_depth < outD; out_depth++)
                            {
                                for(int out_width = 0; out_width < outW; out_width++)
                                {
                                    for(int out_height = 0; out_height < outH; out_height++)
                                    {
                                        ...
                                        Result.__data_float64[(((out_height * outW) + out_width) * outD + out_depth) * outB + batch] = max;
                                        var i = (((out_height * outW) + out_width) * outD + out_depth) * outB + batch;
                                        IndicesX[i] = max_x;
                                        IndicesY[i] = max_y;
                                    }
                            ...
                            for(int out_depth = 0; out_depth < outD; out_depth++)
                            {
                                for(int out_width = 0; out_width < outW; out_width++)
                                {
                                    for(int out_height = 0; out_height < outH; out_height++)
                                    {
                                        ...
                                        Result.__data_int8[(((out_height * outW) + out_width) * outD + out_depth) * outB + batch] = max;
                                    }
                                }
                            }
                        });
                            ...
                            for(int out_depth = 0; out_depth < outD; out_depth++)
                            {
                                for(int out_width = 0; out_width < outW; out_width++)
                                {
                                    for(int out_height = 0; out_height < outH; out_height++)
                                    {
                                        ...
                                        Result.__data_int16[(((out_height * outW) + out_width) * outD + out_depth) * outB + batch] = max;
                                    }
                                }
                            }
                        });
                            ...
                            for(int out_depth = 0; out_depth < outD; out_depth++)
                            {
                                for(int out_width = 0; out_width < outW; out_width++)
                                {
                                    for(int out_height = 0; out_height < outH; out_height++)
                                    {
                                        ...
                                        Result.__data_int32[(((out_height * outW) + out_width) * outD + out_depth) * outB + batch] = max;
                                    }
                                }
                            }
                        });
