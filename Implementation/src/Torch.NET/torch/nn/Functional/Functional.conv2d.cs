...
public static partial class torch
{
    ...
    public static partial class nn
    {
        ...
        public static partial class Functional
        {
            ...
            {
                var outW = (input.__width + 2 * padding - dilation * (weight.__width - 1) - 1) / stride + 1;
                var outH = (input.__height + 2 * padding - dilation * (weight.__height - 1) - 1) / stride + 1;
