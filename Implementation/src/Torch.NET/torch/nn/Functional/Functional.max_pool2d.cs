                ...
                switch(Result.dtype)
                {
                    ...
                    case torch.dtype.half:
                    {
                        for(int batch = 0; batch < outB; batch++)
                        {
                            ...
                            {
                                for(int out_width = 0; out_width < outW; out_width++)
                                {
                                    for(int out_height = 0; out_height < outH; out_height++)
                                    {
                                        var x = out_width * stride - padding;
                                        var y = out_height * stride - padding;
                                        Half max = Half.MinValue;
                                        var max_x = -1;
                                        var max_y = -1;
                                        for(int fx = 0; fx < kernel_size; fx++)
                                        {
                                            ...
                                            for(int fy = 0; fy < kernel_size; fy++)
                                            {
                                                ...
                                                {
                                                    var v = input.__unsafe_get_float16(ox, oy, out_depth, batch);
                                                    if(v > max)
                                                    {
                                                        max = v;
                                                        max_x = ox;
                                        ...
                                        Result.__unsafe_set_float16(max, out_width, out_height, out_depth, batch);
                                    ...
                                    for(int out_height = 0; out_height < outH; out_height++)
                                    {
                                        ...
                                        for(int fx = 0; fx < kernel_size; fx++)
                                        {
                                            ...
                                            for(int fy = 0; fy < kernel_size; fy++)
                                            {
                                                ...
                                                if((oy >= 0) && (oy < inH) && (ox >= 0) && (ox < inW))
                                                {
                                                    var v = input.__unsafe_get_float32(ox, oy, out_depth, batch);
                                                    if(v > max)
                                                    {
                                                        max = v;
                                                        max_x = ox;
                                        ...
                                        Result.__unsafe_set_float32(max, out_width, out_height, out_depth, batch);
                                        var i = (((out_height * outW) + out_width) * outD + out_depth) * outB + batch;
                                        IndicesX[i] = max_x;
                                        IndicesY[i] = max_y;
                                    }
                                    ...
                                    for(int out_height = 0; out_height < outH; out_height++)
                                    {
                                        ...
                                        for(int fx = 0; fx < kernel_size; fx++)
                                        {
                                            ...
                                            for(int fy = 0; fy < kernel_size; fy++)
                                            {
                                                ...
                                                if((oy >= 0) && (oy < inH) && (ox >= 0) && (ox < inW))
                                                {
                                                    var v = input.__unsafe_get_float64(ox, oy, out_depth, batch);
                                                    if(v > max)
                                                    {
                                                        max = v;
                                                        max_x = ox;
                                        ...
                                        Result.__unsafe_set_float64(max, out_width, out_height, out_depth, batch);
                                        var i = (((out_height * outW) + out_width) * outD + out_depth) * outB + batch;
                                        IndicesX[i] = max_x;
                                        IndicesY[i] = max_y;
                                    }
                                    ...
                                    for(int out_height = 0; out_height < outH; out_height++)
                                    {
                                        ...
                                        for(int fx = 0; fx < kernel_size; fx++)
                                        {
                                            ...
                                            for(int fy = 0; fy < kernel_size; fy++)
                                            {
                                                ...
                                                if((oy >= 0) && (oy < inH) && (ox >= 0) && (ox < inW))
                                                {
                                                    var v = input.__unsafe_get_int8(ox, oy, out_depth, batch);
                                                    if(v > max)
                                                    {
                                                        max = v;
                                                        max_x = ox;
                                        ...
                                        Result.__unsafe_set_int8(max, out_width, out_height, out_depth, batch);
                                    }
                                }
                            }
                        }
                                    ...
                                    for(int out_height = 0; out_height < outH; out_height++)
                                    {
                                        ...
                                        for(int fx = 0; fx < kernel_size; fx++)
                                        {
                                            ...
                                            for(int fy = 0; fy < kernel_size; fy++)
                                            {
                                                ...
                                                if((oy >= 0) && (oy < inH) && (ox >= 0) && (ox < inW))
                                                {
                                                    var v = input.__unsafe_get_uint8(ox, oy, out_depth, batch);
                                                    if(v > max)
                                                    {
                                                        max = v;
                                                        max_x = ox;
                                        ...
                                        Result.__unsafe_set_uint8(max, out_width, out_height, out_depth, batch);
                                    }
                                }
                            }
                        }
                                    ...
                                    for(int out_height = 0; out_height < outH; out_height++)
                                    {
                                        ...
                                        for(int fx = 0; fx < kernel_size; fx++)
                                        {
                                            ...
                                            for(int fy = 0; fy < kernel_size; fy++)
                                            {
                                                ...
                                                if((oy >= 0) && (oy < inH) && (ox >= 0) && (ox < inW))
                                                {
                                                    var v = input.__unsafe_get_int16(ox, oy, out_depth, batch);
                                                    if(v > max)
                                                    {
                                                        max = v;
                                                        max_x = ox;
                                        ...
                                        Result.__unsafe_set_int16(max, out_width, out_height, out_depth, batch);
                                    }
                                }
                            }
                        }
                                    ...
                                    for(int out_height = 0; out_height < outH; out_height++)
                                    {
                                        ...
                                        for(int fx = 0; fx < kernel_size; fx++)
                                        {
                                            ...
                                            for(int fy = 0; fy < kernel_size; fy++)
                                            {
                                                ...
                                                if((oy >= 0) && (oy < inH) && (ox >= 0) && (ox < inW))
                                                {
                                                    var v = input.__unsafe_get_int32(ox, oy, out_depth, batch);
                                                    if(v > max)
                                                    {
                                                        max = v;
                                                        max_x = ox;
                                        ...
                                        Result.__unsafe_set_int32(max, out_width, out_height, out_depth, batch);
                                    }
                                }
                            }
                        }
                                    ...
                                    for(int out_height = 0; out_height < outH; out_height++)
                                    {
                                        ...
                                        for(int fx = 0; fx < kernel_size; fx++)
                                        {
                                            ...
                                            for(int fy = 0; fy < kernel_size; fy++)
                                            {
                                                ...
                                                if((oy >= 0) && (oy < inH) && (ox >= 0) && (ox < inW))
                                                {
                                                    var v = input.__unsafe_get_int64(ox, oy, out_depth, batch);
                                                    if(v > max)
                                                    {
                                                        max = v;
                                                        max_x = ox;
                                        ...
                                        Result.__unsafe_set_int64(max, out_width, out_height, out_depth, batch);
                                    }
                                }
                            }
                        }
                                    ...
                                    for(int out_depth = 0; out_depth < outD; out_depth++)
                                    {
                                        for(int out_width = 0; out_width < outW; out_width++)
                                        {
                                            for(int out_height = 0; out_height < outH; out_height++)
                                            {
                                                ...
                                                var v = Result.__unsafe_get_dw_float16(out_width, out_height, out_depth, batch);
                                                input.__unsafe_add_dw_float16(v, max_x, max_y, out_depth, batch);
                                            }
                                        }
                                    }
                                }
                                    ...
                                    for(int out_depth = 0; out_depth < outD; out_depth++)
                                    {
                                        for(int out_width = 0; out_width < outW; out_width++)
                                        {
                                            for(int out_height = 0; out_height < outH; out_height++)
                                            {
                                                ...
                                                var max_x = IndicesX[i];
                                                var max_y = IndicesY[i];
                                                var v = Result.__unsafe_get_dw_float32(out_width, out_height, out_depth, batch);
                                                input.__unsafe_add_dw_float32(v, max_x, max_y, out_depth, batch);
                                            }
                                        }
                                    }
                                }
                                    ...
                                    for(int out_depth = 0; out_depth < outD; out_depth++)
                                    {
                                        for(int out_width = 0; out_width < outW; out_width++)
                                        {
                                            for(int out_height = 0; out_height < outH; out_height++)
                                            {
                                                ...
                                                var max_x = IndicesX[i];
                                                var max_y = IndicesY[i];
                                                var v = Result.__unsafe_get_dw_float64(out_width, out_height, out_depth, batch);
                                                input.__unsafe_add_dw_float64(v, max_x, max_y, out_depth, batch);
                                            }
                                        }
                                    }
                                }
