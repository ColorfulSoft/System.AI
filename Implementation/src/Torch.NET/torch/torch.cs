...
///<summary>The main class of Torch.NET.</summary>
            ...
            switch(dtype)
            {
                case 0:
                {
                    switch(ndim)
                    {
                        case 0:
                        {
                            data = new Tensor(torch.dtype.float16);
                            break;
                        }
                        case 1:
                        {
                            data = new Tensor(width, dtype: torch.dtype.float16);
                            break;
                        }
                        case 2:
                        {
                    ...
                    for(int i = 0; i < src.Length; i++)
                    {
                        src[i] = Half.ToHalf(fs.ReadUInt16());
                    }
                    break;
                }
                case 1:
                ...
                case 2:
                {
                    switch(ndim)
                    {
                        case 0:
                        {
                            data = new Tensor(torch.dtype.float64);
                            break;
                        }
                        case 1:
                        {
                            data = new Tensor(width, dtype: torch.dtype.float64);
                            break;
                        }
                        case 2:
                        {
                ...
                case 4:
                {
                    switch(ndim)
                    {
                        case 0:
                        {
                            data = new Tensor(torch.dtype.int8);
                            break;
                        }
                        case 1:
                        {
                            data = new Tensor(width, dtype: torch.dtype.int8);
                            break;
                        }
                        case 2:
                        {
                ...
                case 5:
                {
                    switch(ndim)
                    {
                        case 0:
                        {
                            data = new Tensor(torch.dtype.int16);
                            break;
                        }
                        case 1:
                        {
                            data = new Tensor(width, dtype: torch.dtype.int16);
                            break;
                        }
                        case 2:
                        {
                ...
                case 6:
                {
                    switch(ndim)
                    {
                        case 0:
                        {
                            data = new Tensor(torch.dtype.int32);
                            break;
                        }
                        case 1:
                        {
                            data = new Tensor(width, dtype: torch.dtype.int32);
                            break;
                        }
                        case 2:
                        {
                ...
                case 8:
                {
                    switch(ndim)
                    {
                        case 0:
                        {
                            data = new Tensor(torch.dtype.@bool);
                            break;
                        }
                        case 1:
                        {
                            data = new Tensor(width, dtype: torch.dtype.@bool);
                            break;
                        }
                        case 2:
                        {
