...
//-> Latest commit: Brykin Gleb, 12.11.2019.
...
public static partial class torch
{
    ...
    public sealed partial class Tensor
    {
        ...
        public static Tensor operator /(Tensor a, Tensor b)
        {
            ...
            {
                throw new TorchException("TorchException: The / operator does not support Boolean tensors.");
            }
