...
namespace torch
{
    ...
    public sealed partial class Tensor
    {
        ...
        private void __RaiseIfDimensionIsInvalid(int width = 1, int height = 1, int depth = 1, int time = 1, int batch = 1)
        {
            if(width <= 0)
            {
                throw new TorchException("The width of the tensor must be positive and greater than 0.");
            }
            if(height <= 0)
            {
                throw new TorchException("The height of the tensor must be positive and greater than 0.");
            }
            if(depth <= 0)
            {
                throw new TorchException("The depth of the tensor must be positive and greater than 0.");
            }
            if(time <= 0)
            {
                throw new TorchException("The number of times of the tensor must be positive and greater than 0.");
            }
            if(batch <= 0)
            {
                throw new TorchException("The batch size of the tensor must be positive and greater than 0.");
            }
        }
