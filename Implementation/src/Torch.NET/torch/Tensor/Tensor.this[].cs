                            ...
                            for(int t = minT; t < maxT; t++)
                            {
                                for(int d = minD; d < maxD; d++)
                                {
                                    for(int h = minH; h < maxH; h++)
                                    {
                                        ...
                                        {
                                            result.__unsafe_set_value(this.__unsafe_get_value(this.__data_float16, w, h, d, t, b), result.__data_float16, w - minW, h - minH, d - minD, t - minT, b - minB);
                                        }
                                    }
                                }
                            }
                            ...
                            for(int t = minT; t < maxT; t++)
                            {
                                for(int d = minD; d < maxD; d++)
                                {
                                    for(int h = minH; h < maxH; h++)
                                    {
                                        for(int w = minW; w < maxW; w++)
                                        {
                                            result.__unsafe_set_value(this.__unsafe_get_value(this.__data_float32, w, h, d, t, b), result.__data_float32, w - minW, h - minH, d - minD, t - minT, b - minB);
                                        }
                                    }
                                }
                            }
                            ...
                            for(int t = minT; t < maxT; t++)
                            {
                                for(int d = minD; d < maxD; d++)
                                {
                                    for(int h = minH; h < maxH; h++)
                                    {
                                        for(int w = minW; w < maxW; w++)
                                        {
                                            result.__unsafe_set_value(this.__unsafe_get_value(this.__data_float64, w, h, d, t, b), result.__data_float64, w - minW, h - minH, d - minD, t - minT, b - minB);
                                        }
                                    }
                                }
                            }
                            ...
                            for(int t = minT; t < maxT; t++)
                            {
                                for(int d = minD; d < maxD; d++)
                                {
                                    for(int h = minH; h < maxH; h++)
                                    {
                                        for(int w = minW; w < maxW; w++)
                                        {
                                            result.__unsafe_set_value(this.__unsafe_get_value(this.__data_uint8, w, h, d, t, b), result.__data_uint8, w - minW, h - minH, d - minD, t - minT, b - minB);
                                        }
                                    }
                                }
                            }
                            ...
                            for(int t = minT; t < maxT; t++)
                            {
                                for(int d = minD; d < maxD; d++)
                                {
                                    for(int h = minH; h < maxH; h++)
                                    {
                                        for(int w = minW; w < maxW; w++)
                                        {
                                            result.__unsafe_set_value(this.__unsafe_get_value(this.__data_int8, w, h, d, t, b), result.__data_int8, w - minW, h - minH, d - minD, t - minT, b - minB);
                                        }
                                    }
                                }
                            }
                            ...
                            for(int t = minT; t < maxT; t++)
                            {
                                for(int d = minD; d < maxD; d++)
                                {
                                    for(int h = minH; h < maxH; h++)
                                    {
                                        for(int w = minW; w < maxW; w++)
                                        {
                                            result.__unsafe_set_value(this.__unsafe_get_value(this.__data_int16, w, h, d, t, b), result.__data_int16, w - minW, h - minH, d - minD, t - minT, b - minB);
                                        }
                                    }
                                }
                            }
                            ...
                            for(int t = minT; t < maxT; t++)
                            {
                                for(int d = minD; d < maxD; d++)
                                {
                                    for(int h = minH; h < maxH; h++)
                                    {
                                        for(int w = minW; w < maxW; w++)
                                        {
                                            result.__unsafe_set_value(this.__unsafe_get_value(this.__data_int32, w, h, d, t, b), result.__data_int32, w - minW, h - minH, d - minD, t - minT, b - minB);
                                        }
                                    }
                                }
                            }
                            ...
                            for(int t = minT; t < maxT; t++)
                            {
                                for(int d = minD; d < maxD; d++)
                                {
                                    for(int h = minH; h < maxH; h++)
                                    {
                                        for(int w = minW; w < maxW; w++)
                                        {
                                            result.__unsafe_set_value(this.__unsafe_get_value(this.__data_int64, w, h, d, t, b), result.__data_int64, w - minW, h - minH, d - minD, t - minT, b - minB);
                                        }
                                    }
                                }
                            }
                            ...
                            for(int t = minT; t < maxT; t++)
                            {
                                for(int d = minD; d < maxD; d++)
                                {
                                    for(int h = minH; h < maxH; h++)
                                    {
                                        for(int w = minW; w < maxW; w++)
                                        {
                                            result.__unsafe_set_value(this.__unsafe_get_value(this.__data_bool, w, h, d, t, b), result.__data_bool, w - minW, h - minH, d - minD, t - minT, b - minB);
                                        }
                                    }
                                }
                            }
