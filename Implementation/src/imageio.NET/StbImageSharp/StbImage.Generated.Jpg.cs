    ...
    public static partial class imageio
    {
        ...
        internal static partial class StbImageSharp
        {
            ...
            public unsafe partial class StbImage
            {
                    ...
                    }
                    {
                        ...
                        for(j = (uint)0; j < z.s.img_y; ++j)
                        {
                            ...
                            for(k = 0; k < decode_n; ++k)
                            {
                                ...
                                coutput[k] = r.resample(z.img_comp[k].linebuf, (y_bot != 0) ? r.line1 : r.line0, (y_bot != 0) ? r.line0 : r.line1, r.w_lores, r.hs);
                                if(++r.ystep >= r.vs)
                                {
                                    r.ystep = 0;
                                    r.line0 = r.line1;
                ...
                public static void* stbi__jpeg_load(stbi__context s, int* x, int* y, int* comp,
